...
from models import model_for_faced, model_for_lemon_gender, model_for_seedv, model_for_physio, model_for_shu, model_for_isruc, model_for_chb, \
...
def main():
    ...
    if params.downstream_dataset == 'FACED':
        ...
        t = Trainer(params, data_loader, model)
        t.train_for_multiclass()
    elif params.downstream_dataset == 'MPI_LEMON-Gender':
        load_dataset = lemon_dataset.LoadDataset(params)
        data_loader = load_dataset.get_data_loader()
        model = model_for_lemon_gender.Model(params)
        t = Trainer(params, data_loader, model)
        t.train_for_multiclass()
    print('Done!!!!!')
